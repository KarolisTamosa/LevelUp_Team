    ...
    public class Program
    {
        ...
        private static void IniciarPrograma()
        {
            ...
            while (!salir)
            {
                ...
                Moneda monedaOrigen = ObtenerMonedaPorEntero(int.Parse(strMonedaOrigen));
                ...
                Moneda monedaDestino = ObtenerMonedaPorEntero(int.Parse(monedaDestinoStr));
                ...
                var importe = double.Parse(importeStr);
